  ...
  languages: [
    {
      name: 'Python',
      description:
        'Python is a high-level, interpreted programming language that emphasizes code readability and ease of use.',
      logo: './assets/images/tags/python.png',
    },
    {
      name: 'Java',
      description:
        'Java is a general-purpose, object-oriented programming language designed to be platform-independent.',
      logo: './assets/images/tags/java.png',
    },
    {
      name: 'JavaScript',
      description:
        'JavaScript is a lightweight, interpreted programming language designed primarily for client-side web development.',
      logo: './assets/images/tags/js.png',
    },
    {
      name: 'Go',
      description:
      ...
      logo: './assets/images/tags/go.png',
    },
    {
      name: 'Kotlin',
      description:
        'Kotlin is used extensively for Android apps, web application, desktop application, and server-side application development. Kotlin was built to be better than Java, and people who use this language are convinced. Most of the Google applications are based on Kotlin.',
      logo: './assets/images/tags/kotlin.png',
    },
    {
      name: 'PHP',
      description:
        'PHP is an open-source programming language created in 1990. Programmers mainly use PHP mainly to write server-side scripts. But developers can also use this language to write command-line scripts, and programmers with high-level PHP coding skills can also use it to develop desktop applications.',
      logo: './assets/images/tags/php.png',
    },
    {
      name: 'C#',
      description:
        'C# supports the concepts of object-oriented programming ,It is one of the most used programming languages for the .NET framework. C# is best suited for applications on Windows, Android, and iOS, as it takes the help of the integrated development environment product, Microsoft Visual C++. C# is used on the back end of several popular websites like Bing, Dell, Visual Studio, and MarketWatch.',
      logo: './assets/images/tags/c-sharp.png',
    },
    {
      name: 'Swift',
      description:
      ...
      logo: './assets/images/tags/swift.png',
    },
    {
      name: 'R',
      description:
    ...
    },
    {
      ...
      logo: './assets/images/tags/matlab.png',
    },
    {
      name: 'TypeScript',
      description:
      ...
      logo: './assets/images/tags/TypeScript.png',
    },
    {
      name: 'Scala',
      description:
      ...
      logo: './assets/images/tags/scala.png',
    },
    {
      name: 'SQL',
      description:
      ...
      logo: './assets/images/tags/sql.png',
    },
    {
      name: 'HTML',
      description:
      ...
      logo: './assets/images/tags/html.png',
    },
    {
      name: 'CSS',
      description:
      ...
      logo: './assets/images/tags/css.png',
    },
    {
      name: 'NoSQL',
      description:
      ...
      logo: './assets/images/tags/nosql.png',
    },
    {
      name: 'Rust',
      description:
      ...
      logo: './assets/images/tags/rust.png',
    },
    {
      name: 'Perl',
      description:
      ...
      logo: './assets/images/tags/perl.png',
    },
    {
      name: 'Ignite Connex',
      description:
        'IgniteConnex is a low-code integration solution. Platform that connect systems together ,Creating versatile data pipelines ,APIs, ETL management tool ,Workflow automation system. Integration tool which allow you to write custom code for the integrations. IgniteConnex is designed for rapid development of OData services over your existing infrastructure. This allows you to seamlessly integrate with Salesforce with minimal effort. IgniteConnex has been specifically designed to target various integration requirements for that usually need customization.',
      logo: './assets/images/tags/ignite_connex.png',
    },
    {
      name: 'Snowflake',
      description:
      ...
      logo: './assets/images/tags/snowflake.png',
    },
    {
      name: 'React. js',
      description:
        "React. js framework is an open-source JavaScript framework and library developed by Facebook. It's used for building interactive user interfaces and web applications quickly and efficiently with significantly less code.",
      logo: './assets/images/tags/reactjs.png',
    },
    {
      name: 'Flutter',
      description:
      ...
      logo: './assets/images/tags/flutter.png',
    },
  ],
};
