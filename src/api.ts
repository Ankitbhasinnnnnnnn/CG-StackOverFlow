const language = {
    "languages": [
      ...
      {
          "name": "C#",
          "description": "C# supports the concepts of object-oriented programming ,It is one of the most used programming languages for the .NET framework. C# is best suited for applications on Windows, Android, and iOS, as it takes the help of the integrated development environment product, Microsoft Visual C++. C# is used on the back end of several popular websites like Bing, Dell, Visual Studio, and MarketWatch.",
      ...
      {
          "name": "NoSQL",
          "description": "NoSQL databases are non-relational databases designed to provide high performance and scalability. And NoSQL databases are often used in big data applications, where data is distributed across many nodes.",
          "logo": "./assets/images/nosql.png"
      },
      {
          "name": "Rust",
          "description": "Rust is a programming language designed to be safe, concurrent, and practical. It is a systems programming language that runs blazingly fast, prevents segfaults, and guarantees thread safety. Rust is also memory-efficient: it uses minimal memory, making it ideal for embedded systems.",
          "logo": "./assets/images/rust.png"
      },
      {
          "name": "Perl",
          "description": "Perl is an interpreted, high-level, general-purpose programming language. Although Perl is not officially an acronym, various backronyms exist, including 'Practical Extraction and Report Language'. Perl was originally developed by Larry Wall in 1987 as a general-purpose Unix scripting language to make report processing easier. Since then, it has undergone many changes and revisions. ",
          "logo": "./assets/images/perl.png"
      },
      {
          "name": "Ignite Connex",
          "description": "IgniteConnex is a low-code integration solution. Platform that connect systems together ,Creating versatile data pipelines ,APIs, ETL management tool ,Workflow automation system. Integration tool which allow you to write custom code for the integrations. IgniteConnex is designed for rapid development of OData services over your existing infrastructure. This allows you to seamlessly integrate with Salesforce with minimal effort. IgniteConnex has been specifically designed to target various integration requirements for that usually need customization.",
          "logo": "./assets/images/ignite_connex.png"
      },
      {
          "name": "Snowflake",
          "description": "Snowflake enables data storage, processing, and analytic solutions that are faster, easier to use, and far more flexible than traditional offerings. The Snowflake data platform is not built on any existing database technology or “big data” software platforms such as Hadoop.",
          "logo": "./assets/images/snowflake.png"
      },
      {
          "name": "React. js",
